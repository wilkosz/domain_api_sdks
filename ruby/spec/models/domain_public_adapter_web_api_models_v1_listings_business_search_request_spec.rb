...
# Unit tests for DomainClient::DomainPublicAdapterWebApiModelsV1ListingsBusinessSearchRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DomainPublicAdapterWebApiModelsV1ListingsBusinessSearchRequest' do
  before do
    # run before each test
    @instance = DomainClient::DomainPublicAdapterWebApiModelsV1ListingsBusinessSearchRequest.new
  end
  ...
  describe 'test an instance of DomainPublicAdapterWebApiModelsV1ListingsBusinessSearchRequest' do
    it 'should create an instance of DomainPublicAdapterWebApiModelsV1ListingsBusinessSearchRequest' do
      expect(@instance).to be_instance_of(DomainClient::DomainPublicAdapterWebApiModelsV1ListingsBusinessSearchRequest)
    end
  end
  ...
  describe 'test attribute "franchise_group_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "sort"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["default", "newestFirst", "lowTotalPriceFirst", "hightTotalPriceFirst", "suburbAsc", "suburbDesc"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "search_mode"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["forSale", "franchiseOpportunity", "franchiseBrand"])
      # validator.allowable_values.each do |value|
