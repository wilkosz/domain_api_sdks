...
module DomainClient
  ...
  class DomainListingAdminServiceV1ModelLandArea
    ...
    def valid?
      unit_validator = EnumAttributeValidator.new('String', ['squareMetres', 'acres', 'hectares', 'squareFeet', 'squareYards', 'squares'])
    ...
    def unit=(unit)
      validator = EnumAttributeValidator.new('String', ['squareMetres', 'acres', 'hectares', 'squareFeet', 'squareYards', 'squares'])
