...
module DomainClient
  ...
  class DomainPublicAdapterWebApiModelsV1ListingsBusinessAddressComponents
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stateShort')
        self.state_short = attributes[:'stateShort']
      end
    ...
    def hash
      [area, district, postcode, region, state_short, street, street_number, suburb, unit_number].hash
    end
