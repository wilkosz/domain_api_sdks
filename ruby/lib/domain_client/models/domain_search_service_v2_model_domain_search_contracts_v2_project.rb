...
module DomainClient
  class DomainSearchServiceV2ModelDomainSearchContractsV2Project
    ...
    attr_accessor :preferred_color_hex
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'preferredColorHex')
        self.preferred_color_hex = attributes[:'preferredColorHex']
      end
      ...
      if attributes.has_key?(:'projectSlug')
        self.project_slug = attributes[:'projectSlug']
      end
    end
    ...
    def valid?
      promo_level_validator = EnumAttributeValidator.new('String', ['Standard', 'Premium'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          preferred_color_hex == o.preferred_color_hex &&
          logo_url == o.logo_url &&
          labels == o.labels &&
    ...
    def hash
      [promo_level, state, id, name, banner_url, preferred_color_hex, logo_url, labels, displayable_address, suburb, features, media, project_slug].hash
    end
