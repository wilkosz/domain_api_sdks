...
module DomainClient
  class DomainListingsServiceV2ModelDomainListingsApiModelQueryResultsListingAdvertiserIdentifiers
    attr_accessor :advertiser_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'advertiserType')
        self.advertiser_type = attributes[:'advertiserType']
      end
    ...
    def valid?
      advertiser_type_validator = EnumAttributeValidator.new('String', ['agency', 'private'])
      return false unless advertiser_type_validator.valid?(@advertiser_type)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] advertiser_type Object to be assigned
    def advertiser_type=(advertiser_type)
      validator = EnumAttributeValidator.new('String', ['agency', 'private'])
      unless validator.valid?(advertiser_type)
        fail ArgumentError, 'invalid value for "advertiser_type", must be one of #{validator.allowable_values}.'
      end
