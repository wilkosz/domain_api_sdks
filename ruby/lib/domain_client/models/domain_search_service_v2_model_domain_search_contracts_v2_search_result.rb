...
module DomainClient
  class DomainSearchServiceV2ModelDomainSearchContractsV2SearchResult
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['PropertyListing', 'Project'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['PropertyListing', 'Project'])
    ...
    def hash
      [type, listing, listings, project].hash
    end
