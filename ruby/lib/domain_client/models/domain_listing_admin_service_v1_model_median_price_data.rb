...
module DomainClient
  ...
  class DomainListingAdminServiceV1ModelMedianPriceData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'declarationText')
        self.declaration_text = attributes[:'declarationText']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          declaration_text == o.declaration_text
    end
    ...
    def hash
      [price_type, suburb, postcode, median_price, source, source_date_from, source_date_to, declaration_text].hash
    end
