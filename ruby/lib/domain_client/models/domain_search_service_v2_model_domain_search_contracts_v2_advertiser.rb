...
module DomainClient
  class DomainSearchServiceV2ModelDomainSearchContractsV2Advertiser
    ...
    attr_accessor :preferred_colour_hex
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'preferredColourHex')
        self.preferred_colour_hex = attributes[:'preferredColourHex']
      end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['Agency', 'Private'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          logo_url == o.logo_url &&
          preferred_colour_hex == o.preferred_colour_hex &&
    ...
    def hash
      [type, id, name, logo_url, preferred_colour_hex, banner_url, contacts].hash
    end
