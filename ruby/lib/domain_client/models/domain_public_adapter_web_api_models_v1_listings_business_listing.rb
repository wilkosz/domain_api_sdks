...
module DomainClient
  ...
  class DomainPublicAdapterWebApiModelsV1ListingsBusinessListing
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'propertyArea')
        self.property_area = attributes[:'propertyArea']
      end
      ...
      if attributes.has_key?(:'auctionDate')
        self.auction_date = attributes[:'auctionDate']
      end
      ...
      if attributes.has_key?(:'carspaceCount')
        self.carspace_count = attributes[:'carspaceCount']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          metadata == o.metadata &&
          carspace_count == o.carspace_count
    end
    ...
    def hash
      [ad, price, advertiser, geo_location, property_area, property_type, address, headline, has_video, media, auction_date, id, metadata, carspace_count].hash
    end
