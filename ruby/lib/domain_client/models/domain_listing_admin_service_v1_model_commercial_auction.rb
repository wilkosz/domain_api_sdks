...
module DomainClient
  ...
  class DomainListingAdminServiceV1ModelCommercialAuction
    # Terms for the auctions, up to 200 characters. Example: \\\"10% deposit, balance 60 days\\\"
    attr_accessor :auction_terms
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'auctionTerms')
        self.auction_terms = attributes[:'auctionTerms']
      end
    ...
    def hash
      [auction_terms, date_time, location].hash
    end
