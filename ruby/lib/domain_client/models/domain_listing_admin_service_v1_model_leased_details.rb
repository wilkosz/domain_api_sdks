...
module DomainClient
  ...
  class DomainListingAdminServiceV1ModelLeasedDetails
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'leasedDuration')
        self.leased_duration = attributes[:'leasedDuration']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          leased_duration == o.leased_duration
    end
    ...
    def hash
      [leased_price, leased_duration].hash
    end
