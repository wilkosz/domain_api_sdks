...
module DomainClient
  ...
  class DomainPublicAdapterWebApiModelsV1EnquiriesRecipientDeliveryStatus
    # Delivery status of the enquiry for the recipient
    attr_accessor :delivery_status

    # Recipient of the enquiry
    ...
    def valid?
      delivery_status_validator = EnumAttributeValidator.new('String', ['queued', 'delivered', 'failed'])
    ...
    def delivery_status=(delivery_status)
      validator = EnumAttributeValidator.new('String', ['queued', 'delivered', 'failed'])
    ...
    def hash
      [delivery_status, recipient, date].hash
    end
