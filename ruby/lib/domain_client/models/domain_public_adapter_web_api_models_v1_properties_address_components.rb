...
module DomainClient
  # Address components
  class DomainPublicAdapterWebApiModelsV1PropertiesAddressComponents
    ...
    # The street type of the property
    attr_accessor :street_type

    # The street type of the property
    attr_accessor :street_type_long

    # The suburb of the property
    ...
    def hash
      [unit_number, street_number, street_name, street_type, street_type_long, suburb, postcode, state].hash
    end
