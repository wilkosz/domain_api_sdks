...
module DomainClient
  ...
  class DomainPublicAdapterWebApiModelsV1PropertiesHistory
    ...
    def self.swagger_types
      {
        :'rentals' => :'Array<DomainPublicAdapterWebApiModelsV1PropertiesRentalActivity>',
        :'sales' => :'Array<DomainPublicAdapterWebApiModelsV1PropertiesSaleActivity>',
        :'suppress' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rentals')
        if (value = attributes[:'rentals']).is_a?(Array)
          self.rentals = value
        end
      end
