...
module DomainClient
  class DomainListingsServiceV2ModelDomainListingsApiModelQueryResultsListingProviderDetails
    attr_accessor :provider_system
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'providerSystem')
        self.provider_system = attributes[:'providerSystem']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          provider_system == o.provider_system &&
    ...
    def hash
      [provider_system, provider_ad_id].hash
    end
