...
module DomainClient
  ...
  class DomainPublicAdapterWebApiModelsV1PropertiesHistoricalPriceEstimate
    ...
    def valid?
      confidence_validator = EnumAttributeValidator.new('String', ['high', 'medium'])
    ...
    def confidence=(confidence)
      validator = EnumAttributeValidator.new('String', ['high', 'medium'])
    ...
    def hash
      [confidence, date, lower_price, upper_price].hash
    end
