...
module DomainClient
  ...
  class DomainListingAdminServiceV1ModelAgentContact
    # Conjunction agent's agency
    attr_accessor :agency_id

    # Domain ID of the contact person at the agency
    attr_accessor :domain_agent_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'domainAgentId')
        self.domain_agent_id = attributes[:'domainAgentId']
      end
      ...
      if attributes.has_key?(:'receiveEmails')
        self.receive_emails = attributes[:'receiveEmails']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          domain_agent_id == o.domain_agent_id &&
          ...
          mobile == o.mobile &&
          email == o.email &&
          receive_emails == o.receive_emails
    end
    ...
    def hash
      [agency_id, domain_agent_id, first_name, last_name, phone, fax, mobile, email, receive_emails].hash
    end
