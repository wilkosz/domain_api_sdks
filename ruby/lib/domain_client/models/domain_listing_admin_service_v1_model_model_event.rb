...
module DomainClient
  ...
  class DomainListingAdminServiceV1ModelModelEvent
    ...
    def valid?
      severity_validator = EnumAttributeValidator.new('String', ['Info', 'Warning', 'Error'])
      return false unless severity_validator.valid?(@severity)
      issue_type_validator = EnumAttributeValidator.new('String', ['Internal', 'External'])
    ...
    def hash
      [severity, issue_type, message].hash
    end
