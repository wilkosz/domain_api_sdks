...
module DomainClient
  class DomainListingsServiceV1ModelDomainListingsApiModelQueryResultsListingPastSaleData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dateOfSale')
        self.date_of_sale = attributes[:'dateOfSale']
      end
    ...
    def hash
      [unit_number, street_number, street, suburb, postcode, state, display_address, date_of_sale, sold_price].hash
    end
