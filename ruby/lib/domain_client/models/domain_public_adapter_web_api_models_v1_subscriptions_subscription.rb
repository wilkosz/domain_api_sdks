...
module DomainClient
  # Subscription
  class DomainPublicAdapterWebApiModelsV1SubscriptionsSubscription
    ...
    def hash
      [resource_type, created, created_by, owner_id, owner_type, subscriber_id, id, updated, updated_by].hash
    end
