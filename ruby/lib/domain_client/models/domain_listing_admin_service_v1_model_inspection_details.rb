...
module DomainClient
  ...
  class DomainListingAdminServiceV1ModelInspectionDetails
    ...
    attr_accessor :inspection_description
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'inspectionDescription')
        self.inspection_description = attributes[:'inspectionDescription']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          inspection_description == o.inspection_description &&
    ...
    def hash
      [inspection_description, inspections].hash
    end
