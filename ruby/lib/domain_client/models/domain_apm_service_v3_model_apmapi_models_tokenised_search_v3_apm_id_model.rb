...
module DomainClient
  class DomainAPMServiceV3ModelAPMAPIModelsTokenisedSearchV3ApmIdModel
    attr_accessor :level
    ...
    def valid?
      level_validator = EnumAttributeValidator.new('String', ['Address', 'Street', 'Suburb', 'Postcode', 'State'])
    ...
    def level=(level)
      validator = EnumAttributeValidator.new('String', ['Address', 'Street', 'Suburb', 'Postcode', 'State'])
