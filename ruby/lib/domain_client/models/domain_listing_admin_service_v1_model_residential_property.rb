...
module DomainClient
  ...
  class DomainListingAdminServiceV1ModelResidentialProperty
    ...
    # Number of bedrooms
    attr_accessor :bed_rooms

    # Number of bathrooms
    attr_accessor :bath_rooms

    # Parking Info
    attr_accessor :parking_info
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bedRooms')
        self.bed_rooms = attributes[:'bedRooms']
      end

      if attributes.has_key?(:'bathRooms')
        self.bath_rooms = attributes[:'bathRooms']
      end

      if attributes.has_key?(:'parkingInfo')
        self.parking_info = attributes[:'parkingInfo']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bed_rooms == o.bed_rooms &&
          bath_rooms == o.bath_rooms &&
    ...
    def hash
      [property_type, bed_rooms, bath_rooms, parking_info, energy_efficiency_rating, images, address, area, land_area, pdfs, is_marked_for_liveability, property_name, location].hash
    end
