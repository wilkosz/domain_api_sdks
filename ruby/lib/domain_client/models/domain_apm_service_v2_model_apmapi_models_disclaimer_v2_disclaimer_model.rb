...
module DomainClient
  class DomainAPMServiceV2ModelAPMAPIModelsDisclaimerV2DisclaimerModel
    attr_accessor :id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'authorityname')
        self.authorityname = attributes[:'authorityname']
      end
    end
    ...
    def hash
      [id, version, text, imageurl, authorityname].hash
    end
