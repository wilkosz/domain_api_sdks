...
module DomainClient
  class DomainSearchServiceV2ModelDomainSearchContractsV2InspectionSchedule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'byAppointment')
        self.by_appointment = attributes[:'byAppointment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          by_appointment == o.by_appointment &&
    ...
    def hash
      [by_appointment, recurring, times].hash
    end
