...
module DomainClient
  class DomainSearchServiceV2ModelDomainSearchContractsV2SoldData
    ...
    def valid?
      source_validator = EnumAttributeValidator.new('String', ['Agency', 'Apm'])
      return false unless source_validator.valid?(@source)
      sale_method_validator = EnumAttributeValidator.new('String', ['NotStated', 'SoldByAuction', 'SoldByPrivateTreaty', 'Withdrawn', 'SoldPriorToAuction'])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new('String', ['Agency', 'Apm'])
    ...
    def sale_method=(sale_method)
      validator = EnumAttributeValidator.new('String', ['NotStated', 'SoldByAuction', 'SoldByPrivateTreaty', 'Withdrawn', 'SoldPriorToAuction'])
    ...
    def hash
      [source, sale_method, sold_date, sold_price].hash
    end
