...
module DomainClient
  # A property photo
  class DomainPublicAdapterWebApiModelsV1PropertiesPhoto
    # The type of photo.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fullUrl')
        self.full_url = attributes[:'fullUrl']
      end
    ...
    def valid?
      image_type_validator = EnumAttributeValidator.new('String', ['Property', 'Floorplan', 'GoogleStreetView'])
    ...
    def image_type=(image_type)
      validator = EnumAttributeValidator.new('String', ['Property', 'Floorplan', 'GoogleStreetView'])
    ...
    def hash
      [image_type, advert_id, date, full_url, rank].hash
    end
