...
module DomainClient
  class DomainAgencyServiceV1ModelAgentDto
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mugShotURL')
        self.mug_shot_url = attributes[:'mugShotURL']
      end
    ...
    def hash
      [date_updated, agency_id, agent_id, email, first_name, mobile, photo, last_name, is_active_profile_page, phone, sale_active, rental_active, secondary_email, facebook_url, twitter_url, agent_video, profile_text, is_hide_sold_leased_listings, google_plus_url, personal_website_url, linked_in_url, fax, mug_shot_url, mug_shot_new, contact_type_code, receives_requests, cre_agent_video_url, receive_scheduled_report_email, profile_url, job_position].hash
    end
