...
module DomainClient
  ...
  class DomainListingAdminServiceV1ModelCommercialListing
    # Occupancy. Can be 'Tenanted', 'Vacant'
    attr_accessor :occupancy_type
    ...
    # Information about current Tenant
    ...
    # Property Details. Either Area or LandArea must be supplied.
    attr_accessor :property_details

    # List of conjunction agents
    attr_accessor :conjunction_agents
    ...
    def self.swagger_types
      {
        ...
        :'unit_details' => :'Array<DomainListingAdminServiceV1ModelSpecificUnitDetail>',
        :'nabers' => :'Float',
        :'sale_terms' => :'String',
        ...
        :'conjunction_agents' => :'Array<DomainListingAdminServiceV1ModelAgentContact>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'occupancyType')
        self.occupancy_type = attributes[:'occupancyType']
      end
      ...
      if attributes.has_key?(:'eoi')
        self.eoi = attributes[:'eoi']
      end
      ...
      if attributes.has_key?(:'unitsOffered')
        self.units_offered = attributes[:'unitsOffered']
      end

      if attributes.has_key?(:'unitDetails')
        if (value = attributes[:'unitDetails']).is_a?(Array)
          self.unit_details = value
        end
      end
      ...
      if attributes.has_key?(:'conjunctionAgents')
        if (value = attributes[:'conjunctionAgents']).is_a?(Array)
          self.conjunction_agents = value
        end
      end
    ...
    def valid?
      occupancy_type_validator = EnumAttributeValidator.new('String', ['tenanted', 'vacant'])
      return false unless occupancy_type_validator.valid?(@occupancy_type)
    ...
    # @param [Object] occupancy_type Object to be assigned
    def occupancy_type=(occupancy_type)
      validator = EnumAttributeValidator.new('String', ['tenanted', 'vacant'])
      unless validator.valid?(occupancy_type)
        fail ArgumentError, 'invalid value for "occupancy_type", must be one of #{validator.allowable_values}.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          unit_details == o.unit_details &&
          nabers == o.nabers &&
          sale_terms == o.sale_terms &&
          auction == o.auction &&
          property_details == o.property_details &&
          conjunction_agents == o.conjunction_agents &&
    ...
    def hash
      [occupancy_type, listing_action, contact_preference, price, lease, eoi, tenant, tender, annual_return, units_offered, unit_details, nabers, sale_terms, auction, property_details, conjunction_agents, highlights, under_offer_or_contract, domain_ad_id, domain_agency_id, provider_ad_id, features, description, summary, inspection_details, media, contacts, other_enquiry_email, receive_emails_to_default_address, is_rural, supplementary].hash
    end
