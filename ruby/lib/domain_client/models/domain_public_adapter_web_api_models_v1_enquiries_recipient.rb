...
module DomainClient
  ...
  class DomainPublicAdapterWebApiModelsV1EnquiriesRecipient
    # Type of recipient
    ...
    def valid?
      recipient_type_validator = EnumAttributeValidator.new('String', ['primary', 'secondary', 'hidden'])
    ...
    def recipient_type=(recipient_type)
      validator = EnumAttributeValidator.new('String', ['primary', 'secondary', 'hidden'])
