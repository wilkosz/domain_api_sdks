...
module DomainClient
  class DomainSearchServiceV2ModelDomainSearchWebApiV2ModelsSearchLocation
    ...
    attr_accessor :include_surrounding_suburbs
    ...
    def self.swagger_types
      {
        ...
        :'suburb' => :'String',
        :'post_code' => :'String',
        :'include_surrounding_suburbs' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'includeSurroundingSuburbs')
        self.include_surrounding_suburbs = attributes[:'includeSurroundingSuburbs']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          include_surrounding_suburbs == o.include_surrounding_suburbs
    end
    ...
    def hash
      [state, region, area, suburb, post_code, include_surrounding_suburbs].hash
    end
